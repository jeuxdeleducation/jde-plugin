...
final class EvenementPostType {
	...
	private function labels(): array {
		return array(
			...
			'featured_image'         => __( 'Image de couverture', 'jde-plugin' ),
			'set_featured_image'     => __( 'Définir l\'image de couverture', 'jde-plugin' ),
			'remove_featured_image'  => __( 'Retirer l\'image de couverture', 'jde-plugin' ),
			'use_featured_image'     => __( 'Utiliser comme image de couverture', 'jde-plugin' ),
